...
-  <del>  write the filenames to the metadata in a way that it is trackable  <del> 
- see if silence detection can be improved, overlap in time can be improved or spatial overlap can be improved
